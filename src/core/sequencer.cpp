...
Sequencer::Sequencer(model::Model& m)
...
void Sequencer::setBpm(float b, const KernelAudio& kernelAudio, int sampleRate)
{
...
void Sequencer::setBpmRaw(float v, int sampleRate)
{
